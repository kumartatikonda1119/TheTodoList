...
function Home() {
  ...
  useEffect(() => {
    const fetchTodos = async () => {
      setLoading(true);
      try {
        const response = await axios.get("https://thetodolist.onrender.com/todo/fetch", {
  ...
  const todoCreate = async () => {
    ...
    try {
      const response = await axios.post(
        "https://thetodolist.onrender.com/todo/create",
        {
          text: newTodo,
          completed: false,
        },
  ...
  const todoStatus = async (id) => {
    ...
    try {
      const response = await axios.put(
        `https://thetodolist.onrender.com/todo/update/${id}`,
        {
          ...todo,
  ...
  const todoDelete = async (id) => {
    try {
      await axios.delete(`https://thetodolist.onrender.com/todo/delete/${id}`, {
        withCredentials: true,
      });
  ...
  const logout = async () => {
    try {
      await axios.get("https://thetodolist.onrender.com/user/logout", {
        withCredentials: true,
      });
